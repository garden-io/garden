...
* **k8s:** skip kubectl diff for container type ([8dfb6a7](https://github.com/garden-io/garden/commit/8dfb6a7))
...
* **core:** add module include field and use content hash for versions ([8bd0b5b](https://github.com/garden-io/garden/commit/8bd0b5b))
