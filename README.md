...
- **Define [tasks](https://github.com/garden-io/garden/tree/v0.12.2/examples/tasks)** that run as part of your deployment process—e.g. database migrations or scaffolding.
