...
- **Define [tasks](https://github.com/garden-io/garden/tree/0.12.10/examples/tasks)** that run as part of your deployment process—e.g. database migrations or scaffolding.
