...
- Define [tasks](https://github.com/garden-io/garden/tree/v0.9.7/examples//tasks) that run as part of your deployment process—e.g. database migrations or scaffolding.
...
- [Example Projects](https://docs.garden.io/examples)—guides based on some of the [examples](https://github.com/garden-io/garden/tree/v0.9.7/examples/).
...
The [examples](https://github.com/garden-io/garden/tree/v0.9.7/examples/) folder of our repository shows a myriad of different ways to use Garden.
...
Please browse our [examples directory](https://github.com/garden-io/garden/tree/v0.9.7/examples/) for full project configurations and further context.
