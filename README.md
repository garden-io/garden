...
- Define [tasks](https://github.com/garden-io/garden/tree/v0.10.0/examples/tasks) that run as part of your deployment process—e.g. database migrations or scaffolding.
...
- [Example Projects](https://docs.garden.io/examples)—guides based on some of the [examples](https://github.com/garden-io/garden/tree/v0.10.0/examples).
...
The [examples](https://github.com/garden-io/garden/tree/v0.10.0/examples) folder of our repository also shows a myriad of different ways to use Garden. Check out the README in each example for more information
