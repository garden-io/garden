...
- [Remote sources example project](https://github.com/garden-io/garden/tree/0.14.17/examples/remote-sources)

- [kubernetes Deploy action type example with config templates](https://github.com/garden-io/garden/tree/0.14.17/examples/k8s-deploy-config-templates)
