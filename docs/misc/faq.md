...
You can use the [copy directive](https://docs.garden.io/reference/module-types/container#build-dependencies-copy) of the `build.dependencies[]` field for that. See e.g. [this example project](https://github.com/garden-io/garden/tree/0.12.35/examples/build-dependencies).
...
See [this example project](https://github.com/garden-io/garden/tree/0.12.35/examples/base-image).
...
If you need the Dockerfile outside of the module root because you want to share it with other modules, you should consider having a single base image instead and then let each module have its own Dockerfile that's built on the base image. See the [base image example project](https://github.com/garden-io/garden/tree/0.12.35/examples/base-image) for an example of this.

### How do I include files/dirs (e.g. shared libraries) from outside the module root with the build context?

See [this example project](https://github.com/garden-io/garden/tree/0.12.35/examples/build-dependencies).
...
See also the [base image example project](https://github.com/garden-io/garden/tree/0.12.35/examples/base-image) for an example of this.
