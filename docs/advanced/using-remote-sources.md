...
Local paths work just the same as remote URLs and you'll still need to [link the repository](#linking-remote-sources-modules-to-local-code) if you want to edit it locally.
