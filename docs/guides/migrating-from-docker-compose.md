...
* Basic familiarity with Garden ([Projects](https://docs.garden.io/v/acorn-0.12/using-garden/projects), [Modules](https://docs.garden.io/v/acorn-0.12/using-garden/modules), [Dev mode](https://docs.garden.io/v/acorn-0.12/guides/code-synchronization-dev-mode)).
