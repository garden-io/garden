...
If you'd like to run Kubernetes locally, please see our [local Kubernetes guide](../plugins/kubernetes/local-k8s/install.md)
...
If you'd like to use a local Kubernetes cluster, please refer to the [Local Kubernetes guide](../plugins/kubernetes/local-k8s/README.md)
for further information. For remote clusters, take a look at the [Remote Kubernetes guide](../plugins/kubernetes/remote-k8s/README.md).

## Windows

You can run Garden on Windows 10 Home, Pro or Enterprise editions.

_Note: The Home edition doesn't support virtualization, but you can still use Garden if you're working with [remote Kubernetes](../plugins/kubernetes/remote-k8s/README.md) and [in-cluster building](../plugins/kubernetes/advanced/in-cluster-building.md)._
