...
If you'd like to run Kubernetes locally, please see our [local Kubernetes guide](../guides/install-local-kubernetes.md)
...
If you'd like to use a local Kubernetes cluster, please refer to the [Local Kubernetes guide](../garden-for/kubernetes/local-kubernetes.md)
for further information. For remote clusters, take a look at the [Remote Kubernetes guide](../garden-for/kubernetes/remote-kubernetes.md).
