...
Take a look at the [gke example project](https://github.com/garden-io/garden/tree/0.12.29/examples/gke)) to see the additional steps required to set up in-cluster building on GKE with Kaniko and GCR as a deployment registry.
