...
For usage information, please refer to the [guides section](https://docs.garden.io/v/acorn-0.12/guides). A good place to start is
...
| Type     | Default                                          | Required |
| -------- | ------------------------------------------------ | -------- |
| `string` | `"gcr.io/kaniko-project/executor:v1.11.0-debug"` | No       |
