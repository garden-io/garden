...
See the [Mounting Kubernetes ConfigMaps](https://docs.garden.io/v/acorn-0.12/k8s-plugins/module-types/container#mounting-kubernetes-configmaps) guide for more info and usage examples.
