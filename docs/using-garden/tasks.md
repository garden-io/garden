...
The full example is [available here](https://github.com/garden-io/garden/tree/0.12.35/examples/vote-helm/postgres/garden.yml). There's [also a version](https://github.com/garden-io/garden/tree/0.12.35/examples/vote) that uses the `container` module type instead of Helm charts.
