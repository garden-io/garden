...
Some of the most commonly used providers are the [local Kubernetes provider](../plugins/kubernetes/local-k8s/README.md) and the [remote Kubernetes provider](../plugins/kubernetes/remote-k8s/README.md).
