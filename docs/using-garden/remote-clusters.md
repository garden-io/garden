...
[resources](../reference/providers/kubernetes#environments[].providers[].resources) and
[storage](../reference/providers/kubernetes#environments[].providers[].storage) sections in the provider reference for
details.
...
[builder resources](../reference/providers/kubernetes#environments[].providers[].resources.builder) reference for
details.
