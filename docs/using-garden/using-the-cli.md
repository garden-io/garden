...
The `terraform` provider includes several commands that facilitate interaction with the Terraform stacks in your project. See the [Terraform guide](../plugins/terraform/README.md#planning-and-applying) for more information.
