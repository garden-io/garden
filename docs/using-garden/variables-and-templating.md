...
{% hint style="warning" %}
Note that [Module variables](https://github.com/garden-io/garden/blob/0.12/docs/using-garden/variables-and-templating.md#module-variables) always take precedence over any of the above, in the context of the module being resolved.
{% endhint %}
