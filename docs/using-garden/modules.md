...
Below is a simple example of a module's `garden.yml` (from the [`demo-project`](https://github.com/garden-io/garden/tree/0.12.48/examples/demo-project) example project):
...
- [terraform](../reference/module-types/terraform.md) modules offer a powerful way to deploy any cloud resources as part of your project. See the [Terraform guide](../plugins/terraform/README.md) for more information.
...
- [A guide on the container module type](../plugins/container.md).
