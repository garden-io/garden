...
3. Have a look at the [examples](https://github.com/garden-io/garden/tree/0.12.34/examples) folder in the Garden repository, which offers several usage examples that you can refer to while building out your project.
