...
projects on GitHub](https://github.com/garden-io/garden/tree/0.13.29/examples) and the section of our docs title [Using Garden](../using-garden/configuration-overview.md), which covers all parts of Garden in detail.
