...
Here's a [complete example project](https://github.com/garden-io/garden/tree/0.13.46/examples/k8s-deploy-patch-resources) using this approach.
...
Here's a [complete example](https://github.com/garden-io/garden/tree/0.13.46/examples/k8s-deploy-shared-manifests) using this approach. The downside though is that this is no longer a valid Kubernetes manifest.
