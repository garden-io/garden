...
- [Remote sources example project](https://github.com/garden-io/garden/tree/0.13.39/examples/remote-sources)

- [kubernetes Deploy action type example with config templates](https://github.com/garden-io/garden/tree/0.13.39/examples/k8s-deploy-config-templates)
