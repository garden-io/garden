...
* [Action Configuration](./k8s-plugins/action-types/README.md)
  ...
  * [Deploy](./k8s-plugins/action-types/deploy/README.md)
    * [Kubernetes](./k8s-plugins/action-types/deploy/kubernetes.md)
    * [Helm](./k8s-plugins/action-types/deploy/helm.md)
    * [PersistentVolumeClaim](./k8s-plugins/action-types/deploy/persistentvolumeclaim.md)
    * [ConfigMap](./k8s-plugins/action-types/deploy/configmap.md)
    * [Container.md](./k8s-plugins/action-types/deploy/container.md)
  * [Run and Test](./k8s-plugins/action-types/run-test/README.md)
    * [Kubernetes-exec](./k8s-plugins/action-types/run-test/kubernetes-exec.md)
    * [Kubernetes-pod](./k8s-plugins/action-types/run-test/kubernetes-pod.md)
    * [Helm-pod](./k8s-plugins/action-types/run-test/helm-pod.md)
    * [Container.md](./k8s-plugins/action-types/run-test/container.md)
