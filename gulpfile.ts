...
const modulePaths = ["garden-cli", "garden-service", "garden-sync"]
...
gulp.task("build", gulp.parallel("garden-cli:build", "garden-service:build", "garden-sync:build-container"))
