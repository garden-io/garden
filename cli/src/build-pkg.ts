...
const targets: { [name: string]: TargetSpec } = {
  "macos-amd64": { pkgType: "node20-macos-x64", handler: pkgMacos, nodeBinaryPlatform: "darwin" },
  "linux-amd64": { pkgType: "node20-linux-x64", handler: pkgLinux, nodeBinaryPlatform: "linux" },
  "windows-amd64": { pkgType: "node20-win-x64", handler: pkgWindows, nodeBinaryPlatform: "win32" },
  "alpine-amd64": { pkgType: "node20-alpine-x64", handler: pkgAlpine, nodeBinaryPlatform: "linuxmusl" },
}
