...
Publish release workflow (triggered by release publish)
  ...
  │
  ▼
Auto-merge release PR workflow (triggered by release publish)
  │
...
If the automated flow fails or you need more control, you can still release manually:
...
10. Create a pull request for the release branch and merge it.
11. Update the `latest-release` branch to the released tag and push it.
12. Check the [homebrew repo](https://github.com/garden-io/homebrew-garden/pulls) for the Homebrew PR and merge it.
