...
The [first section](terraform.md#complete-yaml-schema) contains the complete YAML schema, and the [second section](terraform.md#configuration-keys) describes each schema key.

`terraform` modules also export values that are available in template strings. See the [Outputs](terraform.md#outputs) section below for details.
...
[build](terraform.md#build) &gt; dependencies
...
[build](terraform.md#build) &gt; [dependencies](terraform.md#builddependencies) &gt; name
...
[build](terraform.md#build) &gt; [dependencies](terraform.md#builddependencies) &gt; copy
...
[build](terraform.md#build) &gt; [dependencies](terraform.md#builddependencies) &gt; [copy](terraform.md#builddependenciescopy) &gt; source
...
[build](terraform.md#build) &gt; [dependencies](terraform.md#builddependencies) &gt; [copy](terraform.md#builddependenciescopy) &gt; target
...
[generateFiles](terraform.md#generatefiles) &gt; sourcePath
...
[generateFiles](terraform.md#generatefiles) &gt; targetPath
...
[generateFiles](terraform.md#generatefiles) &gt; value
