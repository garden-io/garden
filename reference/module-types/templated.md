...
Note that the following common Module configuration fields are disallowed for this module type: `build`, `description`, `include`, `exclude`, `repositoryUrl`, `allowPublish` and `generateFiles`
...
The [first section](templated.md#complete-yaml-schema) contains the complete YAML schema, and the [second section](templated.md#configuration-keys) describes each schema key.

`templated` modules also export values that are available in template strings. See the [Outputs](templated.md#outputs) section below for details.
...
[build](templated.md#build) &gt; dependencies
...
[build](templated.md#build) &gt; [dependencies](templated.md#builddependencies) &gt; name
...
[build](templated.md#build) &gt; [dependencies](templated.md#builddependencies) &gt; copy
...
[build](templated.md#build) &gt; [dependencies](templated.md#builddependencies) &gt; [copy](templated.md#builddependenciescopy) &gt; source
...
[build](templated.md#build) &gt; [dependencies](templated.md#builddependencies) &gt; [copy](templated.md#builddependenciescopy) &gt; target
...
[generateFiles](templated.md#generatefiles) &gt; sourcePath
...
[generateFiles](templated.md#generatefiles) &gt; targetPath
...
[generateFiles](templated.md#generatefiles) &gt; value
...
The following keys are available via the `${modules.<module-name>}` template string key for `templated` modules.
