...
The [first section](hadolint.md#complete-yaml-schema) contains the complete YAML schema, and the [second section](hadolint.md#configuration-keys) describes each schema key.

`hadolint` modules also export values that are available in template strings. See the [Outputs](hadolint.md#outputs) section below for details.
...
[build](hadolint.md#build) &gt; dependencies
...
[build](hadolint.md#build) &gt; [dependencies](hadolint.md#builddependencies) &gt; name
...
[build](hadolint.md#build) &gt; [dependencies](hadolint.md#builddependencies) &gt; copy
...
[build](hadolint.md#build) &gt; [dependencies](hadolint.md#builddependencies) &gt; [copy](hadolint.md#builddependenciescopy) &gt; source
...
[build](hadolint.md#build) &gt; [dependencies](hadolint.md#builddependencies) &gt; [copy](hadolint.md#builddependenciescopy) &gt; target
...
[generateFiles](hadolint.md#generatefiles) &gt; sourcePath
...
[generateFiles](hadolint.md#generatefiles) &gt; targetPath
...
[generateFiles](hadolint.md#generatefiles) &gt; value
