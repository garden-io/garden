...
The reference is divided into two sections. The [first section](conftest.md#complete-yaml-schema) contains the complete YAML schema, and the [second section](conftest.md#configuration-keys) describes each schema key.
...
[providers](conftest.md#providers) &gt; name
...
[providers](conftest.md#providers) &gt; dependencies
...
[providers](conftest.md#providers) &gt; environments
...
[providers](conftest.md#providers) &gt; policyPath
...
[providers](conftest.md#providers) &gt; namespace
...
[providers](conftest.md#providers) &gt; testFailureThreshold
