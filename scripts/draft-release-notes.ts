...
async function draftReleaseNotes() {
  ...
  console.log(`Generating release notes for ${curReleaseTag}...`)
  ...
  if (outputStdout) {
    ...
    console.log(`Writing release notes to ${outputPath}`)
    try {
