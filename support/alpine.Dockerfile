...
# garden-base
#
FROM node:18.16.1-alpine@sha256:d5b2a7869a4016b1847986ea52098fa404421e44281bb7615a9e3615e07f37fb as garden-alpine-base-root
...
# gcloud base
#
FROM google/cloud-sdk:437.0.1-alpine@sha256:7d3c2dbfe09f6a818fcdd5d6379ffa641663ef8bad626e0288f7efe30ad56a9e as gcloud-base
