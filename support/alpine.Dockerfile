...
FROM node:22.4.0-alpine3.19@sha256:138d0b5f22718a61ceb6a6d306050fbdb599c35f4bb472bc996e540b14cd76ed as garden-base-root
...
FROM python:3.11.9-alpine3.19@sha256:794533313642577455aa046cf831ce6735337773617d3d5da35a54a851bd70c9 AS aws-builder
...
# gcloud base
#
FROM google/cloud-sdk:483.0.0-alpine@sha256:29a6020626cc119b290fb428f49928b15a40877cdcadd9970d67ddb7b40857cf as gcloud-base
