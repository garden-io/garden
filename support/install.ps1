...
$url = "https://github.com/garden-io/garden/releases/download/v0.8.0-rc1/garden-0.8.0-47b6962-win-amd64.zip"
$zipPath = "$gardenTmpPath\garden-0.8.0-47b6962-win-amd64.zip"
