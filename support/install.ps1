...
$url = "https://github.com/garden-io/garden/releases/download/v0.8.0-rc0/garden-0.8.0-b86c463-win-amd64.zip"
$zipPath = "$gardenTmpPath\garden-0.8.0-b86c463-win-amd64.zip"
