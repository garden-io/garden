...
$url = "https://github.com/garden-io/garden/releases/download/v0.8.0-rc2/garden-0.8.0-rc2-a884d81-win-amd64.zip"
$zipPath = "$gardenTmpPath\garden-0.8.0-rc2-a884d81-win-amd64.zip"
