...
import {
  ...
  DEFAULT_GARDEN_CLOUD_V2_DOMAIN,
  GardenApiVersion,
  gardenEnv,
    ...
    it("should return the event with the correct project metadata", async () => {
      ...
      expect(event).to.eql({
        ...
        properties: {
          ...
          enterpriseDomain: AnalyticsHandler.hash(DEFAULT_GARDEN_CLOUD_V1_DOMAIN),
          enterpriseDomainV2: AnalyticsHandler.hashV2(DEFAULT_GARDEN_CLOUD_V2_DOMAIN),
          isLoggedIn: false,
          customer: undefined,
    ...
    it("should handle projects with no services, tests, or tasks", async () => {
      ...
      expect(event).to.eql({
        ...
        properties: {
          ...
          enterpriseProjectIdV2: undefined,
          enterpriseDomain: AnalyticsHandler.hash(DEFAULT_GARDEN_CLOUD_V1_DOMAIN),
          enterpriseDomainV2: AnalyticsHandler.hashV2(DEFAULT_GARDEN_CLOUD_V1_DOMAIN),
          isLoggedIn: false,
          customer: undefined,
          ciName: analytics["ciName"],
          system: analytics["systemConfig"],
    ...
    it("should return the event as a success", async () => {
      ...
      expect(event).to.eql({
        ...
        properties: {
          ...
          enterpriseProjectId: undefined,
          enterpriseProjectIdV2: undefined,
          enterpriseDomain: AnalyticsHandler.hash(DEFAULT_GARDEN_CLOUD_V2_DOMAIN),
          enterpriseDomainV2: AnalyticsHandler.hashV2(DEFAULT_GARDEN_CLOUD_V2_DOMAIN),
          isLoggedIn: false,
          customer: undefined,
          ciName: analytics["ciName"],
