...
import { environmentNameSchema, importVariablesBaseSchema, projectSourceSchema } from "../../config/project.js"
...
export class GetConfigCommand extends Command<{}, Opts, ConfigDump> {
  ...
  override outputsSchema = () =>
    joi.object().keys({
      ...
      importVariables: importVariablesBaseSchema().description("The 'importVariables' config"),
      actionConfigs: joi
        .object()
        .keys({
