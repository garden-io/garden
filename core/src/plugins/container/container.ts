  ...
  builds: [
    {
      platform: "darwin",
      architecture: "arm64",
      url: `https://progressui-releases.s3.us-west-2.amazonaws.com/${progressToolVersion}/standalone-progressui-v${progressToolVersion}-darwin-arm64`,
      sha256: "72f088c81e1da380e04117af01ebb73b9de0aa3e7058608bc722c9553fa2a411",
    },
    {
      platform: "darwin",
      architecture: "amd64",
      url: `https://progressui-releases.s3.us-west-2.amazonaws.com/${progressToolVersion}/standalone-progressui-v${progressToolVersion}-darwin-amd64`,
      sha256: "eea41c72f27892bc92f0c0d87381533b0de98df83dcdfe611d41caa5ec4fb69e",
    },
    {
      platform: "linux",
      architecture: "arm64",
      url: `https://progressui-releases.s3.us-west-2.amazonaws.com/${progressToolVersion}/standalone-progressui-v${progressToolVersion}-linux-arm64`,
      sha256: "22f9a301687d3ff686ba2f337ce43cfcc98e1ae983b1218362bdb81d37010b15",
    },
    {
      platform: "linux",
      architecture: "amd64",
      url: `https://progressui-releases.s3.us-west-2.amazonaws.com/${progressToolVersion}/standalone-progressui-v${progressToolVersion}-linux-amd64`,
      sha256: "5758e868b7b0fc3be485025ea82ee1e70da00bc1428fec3b7aab7b9864d0ebec",
    },
    {
      platform: "windows",
      architecture: "amd64",
      url: `https://progressui-releases.s3.us-west-2.amazonaws.com/${progressToolVersion}/standalone-progressui-v${progressToolVersion}-windows-amd64`,
