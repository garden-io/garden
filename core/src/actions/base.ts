  ...
  keys: () => ({
    ...
    disabled: joi
      ...
      .description(
        ...
        **Important limitation! The variables imported via \`${objectSpreadKey}\` or \`varfiles\` will _not_ be taken into account.** This flag can only use a limited set of template contexts.
      `
      )
      .meta({ templateContext: ActionConfigContext }),
    environments: joi
