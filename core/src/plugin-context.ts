...
import type { LegacyNamespaceStatus } from "./types/namespace.js"
...
type PluginEvents = {
  ...
  namespaceStatus: (status: LegacyNamespaceStatus) => void
}
...
export class PluginEventBroker extends EventEmitter<PluginEvents, PluginEventType> {
  ...
  constructor(garden: Garden) {
    ...
    this.on("namespaceStatus", (status: LegacyNamespaceStatus) => {
