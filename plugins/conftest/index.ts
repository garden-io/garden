...
import { PluginContext, Log } from "@worldofgeese/sdk/types"
import { dedent, naturalList } from "@worldofgeese/sdk/util/string"
import { matchGlobs, listDirectory } from "@worldofgeese/sdk/util/fs"

// TODO: gradually get rid of these core dependencies, move some to SDK etc.
import { providerConfigBaseSchema, GenericProviderConfig, Provider } from "@worldofgeese/core/build/src/config/provider"
import { joi, joiIdentifier, joiSparseArray } from "@worldofgeese/core/build/src/config/common"
import { baseBuildSpecSchema } from "@worldofgeese/core/build/src/config/module"
import { PluginError, ConfigurationError } from "@worldofgeese/core/build/src/exceptions"
import { getGitHubUrl } from "@worldofgeese/core/build/src/docs/common"
import { renderTemplates } from "@worldofgeese/core/build/src/plugins/kubernetes/helm/common"
import { getK8sProvider } from "@worldofgeese/core/build/src/plugins/kubernetes/util"
import { TestAction, TestActionConfig } from "@worldofgeese/core/build/src/actions/test"
import { TestActionHandlers } from "@worldofgeese/core/build/src/plugin/action-types"
import { uniq } from "lodash"
import { HelmDeployAction } from "@worldofgeese/core/build/src/plugins/kubernetes/helm/config"
import { actionRefMatches } from "@worldofgeese/core/build/src/actions/base"
import { Resolved } from "@worldofgeese/core/build/src/actions/types"
import { DEFAULT_TEST_TIMEOUT_SEC } from "@worldofgeese/core/build/src/constants"
