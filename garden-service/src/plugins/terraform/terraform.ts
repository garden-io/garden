...
export const gardenPlugin = createGardenPlugin({
  ...
  docs: dedent`
    ...
    See the [Terraform guide](${DOCS_BASE_URL}/advanced/terraform) for details and usage information.
  `,
  configSchema,
  handlers: {
    configureProvider,
  ...
  createModuleTypes: [
    {
      ...
      See the [Terraform guide](${DOCS_BASE_URL}/advanced/terraform) for a high-level introduction to the \`terraform\`
      provider.
    `,
