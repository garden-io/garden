...
Check out the individual [module type reference](../reference/module-types/) guides for details on what outputs each module type exposes.
...
For a full reference of the keys available in template strings, please look at the [Template Strings Reference](../reference/template-strings.md), as well as individual [providers](../reference/providers/) for provider outputs, and [module types](../reference/module-types/) for module and runtime output keys.

Also take a look at our [Guides section](https://github.com/garden-io/garden/tree/884fe32802f079fedf2b607913e6c2adfbc3c730/docs/guides/README.md) for various specific uses of Garden.
