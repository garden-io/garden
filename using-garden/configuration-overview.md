...
Garden is configured via `garden.yml` \(or `*.garden.yml`\) configuration files, which Garden collects and compiles into a [Stack Graph](../basics/stack-graph.md) of your project.
...
Also, be sure to look at the [Reference section](https://github.com/garden-io/garden/tree/3c60e61a9d761cf78d3946975bb2f586f43891c4/docs/reference/README.md) for more details on each of the available configuration fields, and the [Template Strings Reference](../reference/template-strings.md) for the keys available in template strings.
