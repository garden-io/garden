...
You can specify files that should be generated as modules are resolved, using the `modules[].generateFiles` field. These files can include any of the same template strings as when [defining modules](module-templates.md#defining-modules).
...
* [`templated-k8s-container example`](https://github.com/garden-io/garden/tree/0.12.15/examples/templated-k8s-container).

## Next steps

Take a look at our [Guides section](https://github.com/garden-io/garden/tree/91943ea6d1014ae37af10556d251c6218294d101/docs/guides/README.md) for more of an in-depth discussion on Garden concepts and capabilities.
